---
name: claude-code-productivity
description: "Claude Code Productivity — Extrair produtividade maxima do Claude Code usando recursos nativos validados — contexto cirurgico,"
---
