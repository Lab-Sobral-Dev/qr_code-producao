---
name: subagentes-paralelos-e-git
description: "Sub-agentes em Paralelo e o Índice do Git — Paralelizar sub-agentes é certo para edição de arquivos disjuntos e errado para"
---
